          ...
          <div className="resume--grid--detail--data">
            <div className="resume--grid--detail--data--name">
              ...
              <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} onAnimationComplete={() => handleComplete()} className="resume--grid--detail--data--name--icons">
                <a href="https://github.com/victor-alvescv" target="_blank" rel="noreferrer">
                  <Icon img={githubIcon} />
                </a>
                <a href="https://www.linkedin.com/in/victor-alves-68538527b/" target="_blank" rel="noreferrer">
                  <Icon img={linkedinIcon} />
                </a>
                <a target="_blank" href="https://docs.google.com/document/d/1eoDcsKkNFYl0iHpXfbQe3CuV34wxfxHQKoJoktNOK4g/edit?usp=sharing">
                  <Icon img={fileIcon} />
                </a>
              </motion.div>
            </div>
